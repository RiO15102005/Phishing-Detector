...
from app.data.free_hosting import FREE_HOSTING
from app.data.suspicious_extensions import URL_EXTENSIONS
from app.data.suspicious_paths import SUSPICIOUS_PATHS
from app.data.tlds import ALL_TLDS
from app.data.url_shorteners import URL_SHORTENERS
